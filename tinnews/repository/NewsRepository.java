...
public class NewsRepository {
    ...
    public LiveData<NewsResponse> getTopHeadlines(String country) {
        MutableLiveData<NewsResponse> topHeadlinesLiveData = new MutableLiveData<>(); // UI thread上执行

        newsApi.getTopHeadlines(country) // this function running on another thread
        ...
        return topHeadlinesLiveData;// UI thread上执行，永远为空，跟着line22之后执行
    }
    ...
    public LiveData<List<Article>> getAllSavedArticles() {
        return database.articleDao().getAllArticles(); // Livedata已经支持了async
    }
